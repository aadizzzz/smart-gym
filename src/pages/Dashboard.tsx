...
export const Dashboard: React.FC = () => {
    ...
    useEffect(() => {
        const fetchLeads = async () => {
            if (gymId) {
                const data = await db.getLeads(gymId);
                setLeads(data);
            }
        };
        fetchLeads();
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="show"
            className="flex-1 overflow-y-auto p-8 pb-20 text-[var(--text-primary)]"
        >
            {/* KPI Grid */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <motion.div variants={item} className="lg:col-span-1 bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 flex flex-col h-full">
                    ...
                    >
                        ...
                        {/* Mock data for visual appeal if no leads */}
                        <motion.div variants={item} className="group flex items-center justify-between p-3 rounded-xl hover:bg-[var(--surface-highlight)] transition-colors cursor-pointer border border-transparent hover:border-[var(--border)]">
                            <div className="flex items-center gap-3">
