                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                        <div>
                            ...
                            <p className="text-[#9db99d] mt-1">Manage gym access, memberships, and billing status.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-surface-dark border border-[#283928] rounded-xl p-4 flex flex-col">
                            <span className="text-[#9db99d] text-xs font-medium uppercase tracking-wider mb-1">Total Members</span>
                        ...
                        <div className="bg-surface-dark border border-[#283928] rounded-xl p-4 flex flex-col">
                            ...
                            <span className="text-2xl font-bold text-white">982</span>
                        </div>
                        <div className="bg-surface-dark border border-[#283928] rounded-xl p-4 flex flex-col">
                    ...
                    {/* Toolbar */}
                    <div className="flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center bg-[#1e1415] p-2 rounded-xl border border-[#283928]">
                        {/* Tabs */}
                        <div className="flex p-1 bg-surface-dark/50 rounded-lg self-stretch lg:self-auto overflow-x-auto">
                            <button className="px-4 py-2 text-sm font-medium text-white bg-[#39282a] shadow rounded-md whitespace-nowrap transition-all">All Members</button>
                            <button className="px-4 py-2 text-sm font-medium text-[#9db99d] hover:text-white rounded-md whitespace-nowrap transition-all hover:bg-white/5">Active</button>
                            <button className="px-4 py-2 text-sm font-medium text-[#9db99d] hover:text-white rounded-md whitespace-nowrap transition-all hover:bg-white/5">Expired</button>
                            <button className="px-4 py-2 text-sm font-medium text-[#9db99d] hover:text-white rounded-md whitespace-nowrap transition-all hover:bg-white/5">Frozen</button>
                        </div>
                        {/* Search & Filter */}
                        <div className="flex items-center gap-3 w-full lg:w-auto">
                            <div className="relative group w-full lg:w-80">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span className="material-symbols-outlined text-[#9db99d] group-focus-within:text-primary transition-colors">search</span>
                                </div>
                                <input className="block w-full pl-10 pr-3 py-2.5 border-none rounded-lg leading-5 bg-surface-dark text-white placeholder-[#9db99d] focus:outline-none focus:ring-2 focus:ring-primary/50 sm:text-sm transition-shadow" placeholder="Search by name, email, or phone..." type="text" />
                            </div>
                            <button className="p-2.5 bg-surface-dark hover:bg-[#39282a] text-[#9db99d] hover:text-white rounded-lg transition-colors border border-transparent hover:border-[#283928]" title="Filter">
                                <span className="material-symbols-outlined">filter_list</span>
                            </button>
                            <button className="p-2.5 bg-surface-dark hover:bg-[#39282a] text-[#9db99d] hover:text-white rounded-lg transition-colors border border-transparent hover:border-[#283928]" title="Export">
                                <span className="material-symbols-outlined">download</span>
                            </button>
                        </div>
                    </div>
                    {/* Table Container */}
                    <div className="bg-surface-dark rounded-xl border border-[#283928] overflow-hidden shadow-xl">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-[#241718] border-b border-[#283928]">
                                        <th className="px-6 py-4 text-xs font-semibold text-[#9db99d] uppercase tracking-wider w-1/4">Member</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-[#9db99d] uppercase tracking-wider w-1/4">Contact</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-[#9db99d] uppercase tracking-wider w-1/6">Plan Type</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-[#9db99d] uppercase tracking-wider w-1/6">Join Date</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-[#9db99d] uppercase tracking-wider w-1/6 text-center">Status</th>
                                        <th className="px-6 py-4 text-xs font-semibold text-[#9db99d] uppercase tracking-wider w-10"></th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-[#283928]">
                                    {/* Row 1 */}
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <div className="text-xs text-[#9db99d]">ID: #8823</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <div className="text-xs text-[#9db99d]">ID: #9941</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {/* Pagination Footer */}
                        <div className="bg-[#1e1415] border-t border-[#283928] px-6 py-4 flex items-center justify-between">
                            <div className="text-sm text-[#9db99d]">
                                Showing <span className="font-medium text-white">1</span> to <span className="font-medium text-white">4</span> of <span className="font-medium text-white">1,240</span> results
                            </div>
                            <div className="flex items-center gap-2">
                                <button className="px-3 py-1 rounded-md bg-[#39282a] text-[#9db99d] hover:text-white hover:bg-surface-border transition-colors text-sm disabled:opacity-50" disabled>
                                    Previous
                                </button>
                                <button className="px-3 py-1 rounded-md bg-[#39282a] text-[#9db99d] hover:text-white hover:bg-surface-border transition-colors text-sm">
                                    Next
                                </button>
                            </div>
                        </div>
