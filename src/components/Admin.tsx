...
export const Admin: React.FC = () => {
    ...
    return (
        <AdminLayout>
            <div className="flex-1 overflow-y-auto p-8 pb-20 text-[var(--text-primary)]">
                {/* KPI Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    {/* Active Members */}
                    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 hover:border-[#3b543b] transition-colors relative group overflow-hidden">
                        ...
                        <div className="flex flex-col gap-1 relative z-10">
                            ...
                            <div className="flex items-end gap-3">
                                <h3 className="text-[var(--text-primary)] text-3xl font-bold">1,240</h3>
                    ...
                    {/* Monthly Revenue */}
                    <div className="bg-[var(--surface)] border border-primary/30 rounded-2xl p-6 shadow-[0_0_20px_rgba(19,236,19,0.05)] relative overflow-hidden group">
                        ...
                        <div className="flex flex-col gap-1 relative z-10">
                            ...
                            <div className="flex items-end gap-3">
                                <h3 className="text-[var(--text-primary)] text-3xl font-bold">$42,500</h3>
                                <span className="text-primary text-sm font-medium mb-1 flex items-center bg-primary/10 px-1.5 py-0.5 rounded">
                                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
                                    8%
                                </span>
                    ...
                    {/* Expiring Soon */}
                    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 hover:border-[#ef4444]/50 transition-colors relative group">
                        <div className="absolute right-0 top-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
                        ...
                        <div className="flex flex-col gap-1 relative z-10">
                            ...
                            <div className="flex items-end gap-3">
                                <h3 className="text-[var(--text-primary)] text-3xl font-bold">14</h3>
                    ...
                    {/* Attendance Today */}
                    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 hover:border-[#3b543b] transition-colors relative group">
                        <div className="absolute right-0 top-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
                        ...
                        <div className="flex flex-col gap-1 relative z-10">
                            ...
                            <div className="flex items-end gap-3">
                                <h3 className="text-[var(--text-primary)] text-3xl font-bold">86</h3>
                                <span className="text-primary text-sm font-medium mb-1 flex items-center bg-primary/10 px-1.5 py-0.5 rounded">
                                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
                                    5%
                                </span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Main Chart Section */}
                    <div className="lg:col-span-2 bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 flex flex-col">
                        ...
                        <div className="flex-1 w-full min-h-[300px] relative">
                            ...
                            <svg className="w-full h-full overflow-visible" viewBox="0 0 800 300">
                                ...
                                <line stroke="var(--border)" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="800" y1="250" y2="250"></line>
                                <line stroke="var(--border)" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="800" y1="190" y2="190"></line>
                                <line stroke="var(--border)" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="800" y1="130" y2="130"></line>
                                <line stroke="var(--border)" strokeDasharray="4 4" strokeWidth="1" x1="0" x2="800" y1="70" y2="70"></line>
                                <defs>
                                ...
                                <circle cx="650" cy="50" fill="var(--background)" r="6" stroke="#13ec13" strokeWidth="3"></circle>
                                <rect fill="var(--border)" height="34" rx="8" width="140" x="580" y="5"></rect>
                                <text fill="var(--text-primary)" fontFamily="Lexend" fontSize="14" fontWeight="600" textAnchor="middle" x="650" y="27">$42,500</text>
                            </svg>
                            {/* X-Axis Labels */}
                            <div className="flex justify-between text-[var(--text-secondary)] text-xs font-medium mt-4 px-2">
                                <span>Jan</span>
                                <span>Feb</span>
                                <span>Mar</span>
                                <span>Apr</span>
                    ...
                    <div className="lg:col-span-1 bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 flex flex-col h-full">
                        <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex flex-col gap-2 overflow-y-auto">
                            {leads.length > 0 ? (
                                leads.map((lead) => (
                                    <div key={lead.id} className="group flex items-center justify-between p-3 rounded-xl hover:bg-[var(--surface-highlight)] transition-colors cursor-pointer border border-transparent hover:border-[var(--border)]">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-[var(--text-primary)] text-sm font-medium group-hover:text-primary transition-colors truncate w-32">{lead.email}</p>
                                                <p className="text-[var(--text-secondary)] text-xs">{new Date(lead.createdAt).toLocaleDateString()}</p>
                                            </div>
                                        </div>
                            ...
                            <div className="group flex items-center justify-between p-3 rounded-xl hover:bg-[var(--surface-highlight)] transition-colors cursor-pointer border border-transparent hover:border-[var(--border)]">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[var(--text-primary)] text-sm font-medium group-hover:text-primary transition-colors">Sarah Connor</p>
                                        <p className="text-[var(--text-secondary)] text-xs">Today, 10:23 AM</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="text-[var(--text-primary)] text-sm font-bold">$120.00</p>
                                    <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-primary/20 text-primary border border-primary/20">
                                        Paid
                                    </span>
                                </div>
                            ...
                            <div className="group flex items-center justify-between p-3 rounded-xl hover:bg-[var(--surface-highlight)] transition-colors cursor-pointer border border-transparent hover:border-[var(--border)]">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[var(--text-primary)] text-sm font-medium group-hover:text-primary transition-colors">Mike Ross</p>
                                        <p className="text-[var(--text-secondary)] text-xs">Yesterday, 2:15 PM</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="text-[var(--text-primary)] text-sm font-bold">$120.00</p>
