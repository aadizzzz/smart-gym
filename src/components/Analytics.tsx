        ...
        <AdminLayout>
           ...
           */}
                    ...
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="hidden md:flex items-center bg-[var(--surface)] rounded-lg px-3 py-1.5 border border-[var(--border)]">
                            <span className="material-symbols-outlined text-[var(--text-secondary)] text-[20px]">calendar_today</span>
                            <span className="text-[var(--text-primary)] text-sm font-medium ml-2">Oct 1 - Oct 31, 2023</span>
                            <span className="material-symbols-outlined text-[var(--text-secondary)] text-[18px] ml-2 cursor-pointer">expand_more</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="flex flex-col gap-1 rounded-2xl p-6 bg-[var(--surface)] border border-[var(--border)] shadow-sm hover:border-primary/30 transition-colors">
                            ...
                            <div className="mt-2 flex items-baseline gap-2">
                                <p className="text-[var(--text-primary)] text-3xl font-bold tracking-tight">$42,500</p>
                                <span className="flex items-center text-primary text-sm font-bold bg-primary/10 px-1.5 py-0.5 rounded">
                                    <span className="material-symbols-outlined text-[14px] mr-0.5">trending_up</span>
                                    15%
                                </span>
                            </div>
                            <p className="text-[var(--text-tertiary)] text-xs mt-1">vs. last month</p>
                        </div>
                        <div className="flex flex-col gap-1 rounded-2xl p-6 bg-[var(--surface)] border border-[var(--border)] shadow-sm hover:border-primary/30 transition-colors">
                            <div className="flex justify-between items-start">
                            ...
                            <div className="mt-2 flex items-baseline gap-2">
                                <p className="text-[var(--text-primary)] text-3xl font-bold tracking-tight">1,240</p>
                                <span className="flex items-center text-primary text-sm font-bold bg-primary/10 px-1.5 py-0.5 rounded">
                                    <span className="material-symbols-outlined text-[14px] mr-0.5">trending_up</span>
                                    4.2%
                                </span>
                    ...
                    <div className="rounded-2xl bg-[var(--surface)] border border-[var(--border)] overflow-hidden mb-6">
                        <div className="px-6 py-4 border-b border-[var(--border)] flex justify-between items-center">
                            <h3 className="text-[var(--text-primary)] text-lg font-bold">At-Risk Members</h3>
                            <button className="text-primary text-sm font-bold hover:text-[var(--text-primary)] transition-colors">View All</button>
                        </div>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="text-[var(--text-secondary)] text-xs uppercase tracking-wider border-b border-[var(--border)]">
                                ...
                                <tbody className="text-[var(--text-primary)] text-sm">
                                    <tr className="group hover:bg-[#28392e] transition-colors">
                                        <td className="px-6 py-4 flex items-center gap-3">
                                            <div className="size-8 rounded-full bg-[var(--surface-highlight)] flex items-center justify-center text-xs font-bold">JD</div>
                                            <span className="font-medium">John Doe</span>
                                        </td>
                                        <td className="px-6 py-4 text-[var(--text-secondary)]">14 days ago</td>
                                        <td className="px-6 py-4 text-[var(--text-secondary)]">1x / month</td>
                                    ...
                                    <tr className="group hover:bg-[#28392e] transition-colors border-t border-[var(--border)]">
                                        <td className="px-6 py-4 flex items-center gap-3">
                                            <div className="size-8 rounded-full bg-[var(--surface-highlight)] flex items-center justify-center text-xs font-bold">AS</div>
                                            <span className="font-medium">Alice Smith</span>
                                        </td>
                                        <td className="px-6 py-4 text-[var(--text-secondary)]">21 days ago</td>
                                        <td className="px-6 py-4 text-[var(--text-secondary)]">2x / month</td>
                                        <td className="px-6 py-4">
